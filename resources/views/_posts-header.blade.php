    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: false }" @click.away="show = false">
                <button class="py-2 pl-3 pr-9 text-sm font-semibold flex w-full lg:w-32 text-left lg:inline-flex"
                    @click="show = !show">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 w-full mt-2 rounded-xl z-50" style="display: none">
                    <a href="/"
                        class="block text-left px-3 text-sm leadinh-6 hover:bg-blue-500 focus:bg-blue-500 hover:text-white focus:text-white">All</a>
                    @foreach ($categories as $category)
                        <a href="/categories/{{ $category->slug }}"
                            class="block text-left px-3 text-sm leadinh-6 hover:bg-blue-500
